...
--
-- Fix (ReRide): run the full script in
--   scripts/migrations/fix_handle_new_user_oauth_email_conflict.sql
-- in Supabase -> SQL -> New query -> Run, then retry Google / OAuth sign-in.
-- ============================================================================
