      ...
      <div className="bg-white border-b border-gray-200 px-4 py-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {!isOwnerSeller && seller.mobile?.trim() && telHrefFromRawPhone(seller.mobile) ? (
              <a
                href={telHrefFromRawPhone(seller.mobile)!}
                className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-gray-100 py-3 text-sm font-semibold text-gray-800 active:bg-gray-200"
                style={{ minHeight: '44px' }}
              >
                <svg className="h-5 w-5 shrink-0 text-gray-600" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="tabular-nums">
                  Call <span className="font-medium text-gray-600">{phoneDisplayCompact(seller.mobile) || seller.mobile.trim()}</span>
                </span>
              </a>
            ) : null}
          </div>
