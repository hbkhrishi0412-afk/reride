...
const NotFoundPage: React.FC<NotFoundPageProps> = ({ onNavigate, currentUser }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center px-4 pb-24 lg:pb-8" data-testid="not-found-page">
      <div className="text-center max-w-lg">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <button type="button" onClick={() => onNavigate(View.HOME)} className="btn-brand-primary min-h-[44px] px-4">
            {t('notFound.home', { defaultValue: 'Go home' })}
          </button>
          <button
            type="button"
            onClick={() => onNavigate(View.USED_CARS)}
            className="px-4 py-2 min-h-[44px] rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50"
          >
          ...
          {isBuyer && (
            <button
              ...
              className="px-4 py-2 min-h-[44px] rounded-lg border border-blue-200 text-blue-700 font-medium hover:bg-blue-50"
            >
