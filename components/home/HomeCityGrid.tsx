...
import { HOME_CITY_ACCENT } from '../../constants/homeDiscovery';
    ...
    >
      {visible.map((city) => (
        <button
          ...
          style={{
            border: `1px solid ${HOME_CITY_ACCENT.ring}`,
        ...
        >
          <div
            ...
            style={{ background: HOME_CITY_ACCENT.header }}
          >
            <CityMonument city={city.name} className="mc-monument" color={HOME_CITY_ACCENT.solid} />
            <div className="absolute top-3 right-3" aria-hidden="true">
              <span
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/80"
                style={{ border: `1px solid ${HOME_CITY_ACCENT.ring}` }}
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" style={{ color: HOME_CITY_ACCENT.pin }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <span
                ...
                style={{ color: HOME_CITY_ACCENT.solid, opacity: 0.12 }}
              >
                {city.abbr}
              </span>
            </div>
          ...
          <div className={`${isMobile ? 'px-3 pt-2.5 pb-3' : 'px-4 pt-3 pb-4'} flex flex-col gap-2`}>
            ...
            {city.total > 0 ? (
              <span
                ...
                style={{ backgroundColor: 'rgba(255,107,53,0.10)', color: HOME_CITY_ACCENT.pin }}
              >
                <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: HOME_CITY_ACCENT.pin }} aria-hidden />
