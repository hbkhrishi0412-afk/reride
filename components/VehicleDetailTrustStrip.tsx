...
/** Desktop listing detail — same cues as mobile trust strip. */
export const VehicleDetailTrustStrip: React.FC = () => {
  ...
  return (
    <section
      className="rounded-xl border border-emerald-100 bg-emerald-50/80 px-4 py-3"
    ...
    >
      ...
      <ul className="grid sm:grid-cols-2 gap-1.5 text-xs text-emerald-900">
        {items.map((text) => (
...
export default VehicleDetailTrustStrip;
