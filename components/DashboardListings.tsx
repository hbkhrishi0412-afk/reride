          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                // Navigate to add vehicle form - this should be handled by parent
                if (onEditVehicle) {
                  // Trigger a new vehicle by calling with a new vehicle object
                  onEditVehicle({} as Vehicle);
                }
              }}
              className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-spinny-orange transition-colors text-center cursor-pointer"
            >
